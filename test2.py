...
def save_to_tecplot(N, r_history, filename):
    with open(filename, 'w') as f:
        f.write("TITLE = \"Residual History\"\n")
        f.write("VARIABLES = \"Iteration\", \"Residual Norm\"\n")
        f.write("ZONE T=\"N={}\", I={}, F=POINT\n".format(N, len(r_history)))
        for k, r_norm in enumerate(r_history):
            f.write("{} {}\n".format(k, r_norm))
...
def main():
    ...
    for N in N_values:
        ...
        save_to_tecplot(N, r_history, f"residual_N_{N}.plt")
